<!-- src/components/business/AddressCard.vue -->
<template>
  <div class="bg-slate-950/80 border border-slate-800 rounded-2xl px-4 py-3 space-y-3">
    <div>
      <h2 class="text-[11px] font-semibold text-slate-50">Address</h2>
      <p class="text-[9px] text-slate-500">Displayed on your booking page and in confirmations.</p>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-[10px]">
      <!-- Line 1 -->
      <div class="space-y-1 md:col-span-2">
        <label class="block text-[8px] text-slate-500">Address line 1</label>
        <input
          v-model="form.line1"
          type="text"
      ...
      <!-- Line 2 -->
      <div class="space-y-1 md:col-span-2">
        <label class="block text-[8px] text-slate-500">Address line 2</label>
        <input
          v-model="form.line2"
          type="text"
          class="w-full rounded-xl bg-slate-950 border border-slate-800 px-2 py-1.5 text-[10px] text-slate-100 outline-none focus:border-brand-500/80"
      ...
      <!-- City -->
      <div class="space-y-1">
        <label class="block text-[8px] text-slate-500">City / Municipality</label>
        <input
          v-model="form.city"
          type="text"
          class="w-full rounded-xl bg-slate-950 border border-slate-800 px-2 py-1.5 text-[10px] text-slate-100 outline-none focus:border-brand-500/80"
      ...
      <!-- Province -->
      <div class="space-y-1">
        <label class="block text-[8px] text-slate-500">Province / State</label>
        <input
      ...
      <!-- Postal -->
      <div class="space-y-1">
        <label class="block text-[8px] text-slate-500">Postal code</label>
        <input
      ...
      <!-- Country -->
      <div class="space-y-1">
        <label class="block text-[8px] text-slate-500">Country</label>
        <input
